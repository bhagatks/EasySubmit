...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "EasySubmit.ai — Beat every ATS, free with your own AI key" },
      {
        property: "og:description",
        content:
          "Custom resumes per job + one-click apply Chrome extension. BYOK, free daily usage, ATS-guaranteed.",
      },
    ],
  }),
  component: Landing,
    ...
    <header className="sticky top-0 z-50 border-b border-border/40 bg-background/70 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-8 text-sm text-muted-foreground md:flex">
          ...
          <a href="#ats" className="transition hover:text-foreground">ATS Guarantee</a>
          <a href="#byok" className="transition hover:text-foreground">BYOK</a>
          <Link to="/extension" className="transition hover:text-foreground">Extension</Link>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link to="/app">
              <Button variant="hero" size="xl">
                Start applying free <ArrowRight className="h-5 w-5" />
              </Button>
            </Link>
            <Link to="/extension">
