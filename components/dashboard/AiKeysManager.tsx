  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-display text-3xl font-semibold tracking-tight">AI Keys</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Vault BYOK keys per provider. Raw secrets never leave Supabase Vault.
          </p>
        </div>
        <Button
          type="button"
      ...
      {keys.length === 0 && !editor ? (
        <div className="rounded-2xl border border-dashed border-border bg-surface/40 p-8 text-center">
          <p className="text-sm text-muted-foreground">
            No vaulted keys yet. Add your first provider key to ignite the engine.
          </p>
          <Button
            type="button"
            variant="hero"
      ...
      {editor ? (
        <div className="rounded-2xl border border-primary/30 bg-[oklch(0.16_0.04_268)] p-4 sm:p-6">
          <IgnitionGate
            variant="manage"
            apiKeyInputId={
              editor.mode === "edit"
            ...
            manageDescription={
              editor.mode === "edit"
                ...
                : "Pick a provider and paste your API key — same validation flow as onboarding Launch."
            }
