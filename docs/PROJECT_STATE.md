...
- **Resume spec** — `docs/resume/RULES.md`; golden templates in `assets/resume/templates/`; `lib/resume/resumeSpec.ts`; **`lib/resume/summary-rules.ts`** — Professional Summary standard (4 sentences, 70–80 words, banned phrases); **`lib/resume/skills-rules.ts`** — Skills standard (6–20 manual, 15–20 AI/deterministic, banned slot-wasters, prose detection); validated in AI enhance, deterministic enhancer, readiness score, and Studio editor; Fuel panel sample download via `/api/resume/ats-template`
...
- **Workday one-click apply E2E** — real Workday field fill pending — see [`docs/WORKDAY_ONE_CLICK_APPLY.md`](./WORKDAY_ONE_CLICK_APPLY.md)
